...
public class LevelActivity extends AppCompatActivity {
    ...
    Long referenceTimestamp = 1591373764162L;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostReference = FirebaseDatabase.getInstance().getReference("distancesensor");
        mPostReference.addValueEventListener(valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //Grafic 1
                final LineDataSet lineDataSet = new LineDataSet(yData, "Water level(cm)");
                ...
                Temp_linechart.setDescription("Water level(cm)");
