...
public class MoistureActivity extends AppCompatActivity {
    ...
    Long referenceTimestamp = 1591373762735L;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostReference = FirebaseDatabase.getInstance().getReference("soilmoisture");
        mPostReference.addValueEventListener(valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    String SV = ds.child("moisture").getValue().toString();
                ...
                //Grafic 1
                final LineDataSet lineDataSet = new LineDataSet(yData, "Soil Moisture");
                ...
                Temp_linechart.setDescription(">800 -> Dry | 800 -> Wet");
