...
public class RainActivity extends AppCompatActivity {
    ...
    Long referenceTimestamp = 1591373763542L;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostReference = FirebaseDatabase.getInstance().getReference("rainsensor");
        mPostReference.addValueEventListener(valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    String SV = ds.child("rain").getValue().toString();
                ...
                //Grafic 1
                final LineDataSet lineDataSet = new LineDataSet(yData, "Rain");
                ...
                Temp_linechart.setDescription(">700->Not Raining |  <700->Raining");
